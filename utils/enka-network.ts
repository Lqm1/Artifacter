...
export const fightProps = [
  ...
  { type: "Energy Recharge", prop: 23, icon: "FIGHT_PROP_CHARGE_EFFICIENCY" },
  {
    ...
    prop: 30,
    icon: "FIGHT_PROP_PHYSICAL_ADD_HURT",
  },
...
export const statToString = (
  ...
  isFlat(type)
    ...
    : `${(value * (x100 ? 100 : 1)).toLocaleString(undefined, {
...
const isFlat = (type: string | undefined) =>
  ["Base ATK", "HP", "ATK", "DEF", "Elemental Mastery"].some((e) => e === type);
